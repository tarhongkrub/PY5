# ไฟล์หลักสำหรับกดรันโปรแกรมและควบคุมลูปการทำงาน โมดูล Leap frog, Softening และ Numba และinitial conditions แบบปรับค่าได้(ระบุ:adjustaable) และphysics engineทั้งหมดไว้
import numpy as np
...
def create_galaxy(N_d, N_b, offset, velocity, tilt_deg, color_theme, size_scale=1.0):
    ...
    disk_scale = 3.0 * size_scale #Adjustable
